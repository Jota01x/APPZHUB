...
const Dashboard: React.FC<DashboardProps> = ({ setView }) => {
  ...
  const getChartData = () => {
    switch (activeRange) {
      ...
      case '7dias':
        return [
          { time: 'Segunda', value: 0 },
          { time: 'Terça', value: 0 },
          { time: 'Quarta', value: 0 },
          { time: 'Quinta', value: 0 },
          { time: 'Sexta', value: 0 },
          { time: 'Sábado', value: 0 },
          { time: 'Domingo', value: 0 },
        ];
      case '30dias':
        return [
          { time: '01/06', value: 0 },
    ...
    <div className="flex flex-col space-y-6 w-full max-w-[1200px] mx-auto py-4">
      ...
      <div className="flex justify-center pb-12">
        <button 
          ...
          className="px-12 py-5 bg-indigo-600 text-white border border-indigo-500/20 hover:bg-indigo-700 rounded-2xl transition-all group flex items-center gap-5 shadow-[0_20px_40px_-10px_rgba(37,99,235,0.3)] active:scale-95"
        >
