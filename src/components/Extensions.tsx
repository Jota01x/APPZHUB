            ...
            <div className="mt-8 relative z-10">
              {ext.url ? (
                <a 
                  ...
                  className={`w-full flex items-center justify-center space-x-2 py-5 ${ext.title.includes('Netlify') ? 'bg-indigo-600 text-white hover:bg-indigo-700 shadow-indigo-600/20' : 'bg-emerald-600 text-white hover:bg-emerald-700'} rounded-[1.5rem] font-black uppercase tracking-widest text-xs transition-all shadow-lg active:scale-95`}
                >
