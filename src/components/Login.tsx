      ...
      >
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <button
              onClick={handleLogin}
              className="w-full flex items-center justify-center space-x-4 bg-zinc-100 text-zinc-950 py-5 rounded-[1.5rem] font-black uppercase tracking-[0.25em] text-[10px] hover:bg-white transition-all shadow-xl active:scale-[0.98]"
            >
              <LogIn size={16} />
          ...
          <div className="p-8 bg-zinc-950/50 border border-zinc-800 rounded-3xl text-left space-y-4">
            <div className="flex items-center space-x-4 group">
              <div className="w-2 h-2 rounded-full bg-indigo-500 shadow-[0_0_8px_rgba(234,179,8,0.5)] group-hover:scale-125 transition-transform" />
