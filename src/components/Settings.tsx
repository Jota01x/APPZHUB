          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <button
                ...
                className="w-full mt-8 py-5 bg-indigo-600 text-white rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] hover:bg-indigo-700 transition-all flex items-center justify-center space-x-3"
              >
                <Save size={16} />
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-4 flex items-center justify-between group">
                <span className="font-mono text-xs text-indigo-400 font-bold">rodrigosuporteapp@gmail.com</span>
                <button 
                  onClick={copyEmail}
