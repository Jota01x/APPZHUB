...
import { Globe, Wand2, Target, Briefcase, Users, MessageSquare, MessageCircle, ArrowRight, ArrowLeft, Loader2, Database, Copy, Check, Eye, ChevronDown, ChevronUp, ChevronRight, Layout, PanelLeftClose, PanelLeftOpen, Star, Zap, ExternalLink, Terminal, DollarSign, Layers } from 'lucide-react';
...
const SiteCreator: React.FC<Props> = ({ setView }) => {
  ...
  const STYLE_PRESETS = [
    ...
    { id: 'maximalist', name: 'Bold/Maximalista', icon: Globe },
  ];
  ...
  const MODEL_PRESETS = [
    ...
    { id: 'quiz', name: 'Quiz Interativo', description: 'Engajamento máximo com gamificação interativa.' },
  ...
  const steps = [
    ...
    { id: 2, name: 'Negócio', icon: Users },
    { id: 3, name: 'Site', icon: Briefcase },
          ...
          {step === 2 && (
            ...
            >
              <div className="bg-zinc-900 p-8 rounded-3xl border border-zinc-800 shadow-xl space-y-6">
                <div className="flex items-center space-x-3 text-indigo-400">
                  <Users size={24} />
                  <h3 className="text-2xl font-black text-white uppercase tracking-tighter">Localização do Negócio</h3>
                </div>
          ...
          {step === 3 && (
            ...
            >
              <div className="bg-zinc-900 p-6 sm:p-8 rounded-3xl border border-zinc-800 shadow-xl space-y-8">
                <div className="flex items-center space-x-3 text-indigo-400">
                  <Briefcase size={24} />
                  <h3 className="text-2xl font-black text-white uppercase tracking-tighter">Modelagem do Site</h3>
                </div>
                      ...
                      {STYLE_PRESETS.map((style) => (
                        <button
                          ...
                          className={`flex items-center justify-between p-3 rounded-xl border transition-all ${
                            siteStyle === style.id ? 'bg-indigo-600 border-indigo-500 text-white scale-105 shadow-lg shadow-indigo-500/20' : 'bg-zinc-800/40 border-zinc-700/50 text-zinc-400 hover:border-zinc-600 hover:text-zinc-200 hover:bg-zinc-800/60'
                          }`}
                        >
                      ...
                      {MODEL_PRESETS.map((model) => (
                        <button
                          ...
                          className={`w-full flex items-center justify-between p-3 rounded-xl border transition-all ${
                            selectedModel === model.id ? 'bg-indigo-600 border-indigo-500 text-white scale-105 shadow-lg shadow-indigo-500/20' : 'bg-zinc-800/40 border-zinc-700/50 text-zinc-400 hover:border-zinc-600 hover:text-zinc-200 hover:bg-zinc-800/60'
                          }`}
                        >
...
O site deve ser moderno, totalmente responsivo para celular e desktop, e focado em conversão.`;
                  ...
                  <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-6 sm:p-8 flex flex-col md:flex-row items-center gap-8 group hover:border-indigo-500/30 transition-all">
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="w-full md:w-auto flex items-center justify-center space-x-4 bg-indigo-600 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-indigo-700 transition-all shadow-[0_10px_25px_rgba(37,99,235,0.3)] active:scale-95 shrink-0"
                    >
          ...
          {step === 4 && (
            ...
            >
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 flex flex-wrap items-center gap-8 shadow-xl">
                <div className="space-y-1">
                  <p className="text-[8px] font-black text-zinc-600 uppercase tracking-widest">Site</p>
      ...
      <div className="flex items-center justify-between pt-6 border-t border-zinc-800">
        ...
        <button
          ...
          className="flex items-center space-x-3 bg-indigo-600 text-white px-8 py-3.5 rounded-xl font-black uppercase tracking-widest text-[10px] hover:bg-indigo-700 transition-all shadow-[0_5px_15px_rgba(37,99,235,0.3)] active:scale-95 disabled:opacity-40"
        >
          <span>
